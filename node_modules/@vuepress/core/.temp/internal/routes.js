...
import GlobalLayout from "F:\\vuePress\\my-vue-press\\node_modules\\@vuepress\\core\\lib\\client\\components\\GlobalLayout.vue"
...
export const routes = [
  {
    ...
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-02cdd3e5").then(next)
    },
  },
  {
    path: "/index.html",
  ...
  {
    name: "v-66ce9de1",
    path: "/demon/demon1.html",
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-66ce9de1").then(next)
    },
  },
  {
    name: "v-21ed9dc2",
    path: "/demon/demon2.html",
    component: GlobalLayout,
    beforeEnter: (to, from, next) => {
      ensureAsyncComponentsLoaded("Layout", "v-21ed9dc2").then(next)
    },
  },
  {
    name: "v-b1564aac",
